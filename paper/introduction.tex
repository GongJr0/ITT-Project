...
\noindent International trade relations has been proven to be mutually beneficial over the centuries of economic history. 
...
A variable of interest that constantly appeared in models of all complexity was \textbf{labor productivity}.
...
\noindent Given all agents are rational, the model suggests that only the comparatively productive firms will be able to cover the fixed costs of entering the export market through efficient generation of revenue. 
...
\noindent Effects of international trade on labor productivity may differ for different subgroups of firms. 
...
\noindent There are numerous studies that focus on the relationship between productivity and export status of firms. 
...
Plant-level data from U.S. based manufacturers between 1976 and 1987 is used to compare the productivity of exporting and non-exporting plants.
...
They also uncover a one-sided causal relationship where productive firms are likely to become exporters. 
This outcome is aligned with the expectations of Melitz's model as well.

\vspace{\baselineskip}

\noindent Another interesting study has been published by Atkin, Khandelwal, and Osman where a survey among rug producers in Egypt is conducted. 
...
\noindent The experiments starts with both groups being unaware of the export opportunities that will be presented to the treatment group.
...
By extension, they capture the \enquote{learning by doing}\footnote{The terms refers to the fact that producers gain experience and optimize their processes over time.} effect of exporting through a measurable difference in quality between the treatment group pre/post export opportunity. 
...
Treatment group produces much higher quality rugs compared to the control group at the same production time. This shows that exporting has positive effect on treatment groups. 
