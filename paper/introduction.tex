...
\noindent Given all agents are rational, the model suggests that comparatively productive firms will be able to cover the fixed costs of entering the export market through efficient generation of revenue. 
