...
Effects of international trade on labor productivity may differ for different sub-groups of firms. 
...
\begin{itemize}
    \item H1: Labor productivity of exporters show statistically significant differences from that of non-exporters in all levels of productivity.
    \item H2: Multinational firms' labor productivity distribution is not same as domestic firms for both exporters and non-exporters.
    \item H3: As firms grow in size, the gap in labor productivity between exporters and non-exporters tends to decrease as larger firms can utilize economies of scale regardless of their market scope.
