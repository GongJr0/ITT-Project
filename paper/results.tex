...
\end{table}
{\footnotesize $^*$ Both samples being compared have a small sample size ($n_i = n_j = 20$). The $p$-value is included but should not be treated as accurate. Refer to the raw observations in Appendix~\ref{subsec:a2_empirical}. Visual observation aligns with the test results but the $p$-values themselves are unconfirmable.}
...
\end{table}
{\footnotesize Refer to the footnote on Table~\ref{tab:ks_sizeband_exp_nexp} regarding $p$-values marked with $^*$.}
\vspace{0.5\baselineskip}
