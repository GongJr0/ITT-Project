...
Therefore, a stricter, two-sided equality test is preferred. We accept the assumption that Exporters have greater productivity where a significant difference of distributions is observed.\footnote{Refer to Appendix~\ref{subsec:a2_empirical} for visual confirmation that Exporters have greater productivity in these cases. We will not provide a robust and statistically supported proof.}