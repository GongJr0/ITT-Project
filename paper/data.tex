...
This study utilizes a \href{https://www.ons.gov.uk/economy/economicoutputandproductivity/productivitymeasures/datasets/tradeandproductivityingreatbritainevidencefromfirmlevelmicrodata}{dataset} of 1,800 entries published by the \enquote{Office for National Statistics} (ONS) of the United Kingdom.
...
Unfortunately, the dataset is not recorded at the firm level.
...
The data measures quantiles $\hat{Q} = \lbrace Q_{10}, Q_{25}, Q_{50}, Q_{75}, Q_{90}\rbrace$ alongside the mean $\bigg(\overline{aGVA}\bigg)$ and the standard deviation ($S_{aGVA}$).
