...
\noindent The data measures quantiles $\hat{Q} = \lbrace Q_{10}, Q_{25}, Q_{50}, Q_{75}, Q_{90}\rbrace$ alongside the mean $\bigg(\overline{aGVA}\bigg)$ and the standard deviation ($S_{aGVA}$).
